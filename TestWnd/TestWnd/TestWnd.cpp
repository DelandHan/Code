...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
	   CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, nullptr, nullptr, hInstance, (LPVOID)100);
   
   SetWindowLongPtr(hWnd, GWLP_USERDATA, (long)233);
...
{
	std::cout << GetWindowLongPtr(hWnd, GWLP_USERDATA) << std::endl;
	switch (message)
    {
    case WM_COMMAND:
        {
